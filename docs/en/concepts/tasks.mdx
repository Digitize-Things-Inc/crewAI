...
| **Force Single Tool** _(optional)_ | `force_single_tool` | `Optional[bool]`           | Require the assigned agent to invoke its lone tool before providing a final answer. Inherits the agent setting when omitted. |
